		...
		<div id="dashboard" class="">
			...
			<br>
				...
				<div class="card-body">
					...
					<a href="<?php echo RUTA_URL ?>Psychologist/prefencia" class="btn btn-outline-secondary">¡Comienza!</a>
				</div>
				...
				<div class="card text-center">
					...
					(MODELO PNL) </h5>
					    <!--<p class="card-text">With supporting text below as a natural lead-in to additional content.</p>-->
					    <a href="<?php echo RUTA_URL ?>Psychologist/modelopnl
					...
					<div class="card-header">
					  ...
					  <div class="card-body">
					    ...
					    <!--<p class="card-text">With supporting text below as a natural lead-in to additional content.</p>-->
					    <a href="<?php echo RUTA_URL ?>Psychologist/Honey" class="btn btn-outline-secondary">¡Comienza!</a>
					  </div>
					  <div class="card-footer text-muted">
					    9 days ago
					  </div>
